...
public class hiding_PVO {
	public static void main(String[] args) {
		...
		try {
			test = new imagingRGB();
			matrix = test.read("DE-stego_PVO.jpg");
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(0);
		}
		...
		try {
			test = new imagingRGB();
			matrix = test.read("DE-stego_PVO_1.jpg");
		} catch (Exception e) {
			e.printStackTrace();
			System.exit(0);
		}
		...
		try {
			//new PSNR("DE-stego_PVO.jpg", "DE-stego_PVO_1.jpg");
			//new PSNR("DE-stego_PVO.jpg", "DE-stego_PVO_2.jpg");
		} catch (Exception e) {
			e.getStackTrace();
		}
	}
